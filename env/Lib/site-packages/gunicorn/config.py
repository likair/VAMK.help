...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 -b [::1]:8000 test:vamk

        will bind the `test:vamk` application on localhost both on ipv6
        and ipv4 interfaces.
        """
...
class Env(Setting):
    ...
    desc = """\
        ...
        Pass variables to the execution environment. Ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 --env FOO=1 test:vamk
...
class Paste(Setting):
    ...
    desc = """\
        ...
        symbol followed by the name of an vamk section from the config file,
