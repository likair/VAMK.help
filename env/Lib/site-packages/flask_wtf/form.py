...
class Form(SecureForm):
    ...
    :param secret_key: a secret key for building CSRF tokens. If this isn't
                       ...
                       * WTF_CSRF_SECRET_KEY config of vamk vamk
                       * SECRET_KEY config of vamk vamk
                       * session secret key
