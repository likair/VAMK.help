...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, vamk) tuple."""
...
class SQLAlchemy(object):
    ...
    the second case a :meth:`vamk.Flask.app_context` has to exist.
    ...
    versioning examples.::
        ...
        vamk = Flask(__name__)
        db = SQLAlchemy(vamk, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(vamk)).
        """
