...
class CGIRootFix(object):
    ...
    and you have problems with your vamk root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your vamk is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your vamk, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the vamk.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        vamk = HeaderRewriterFix(vamk, remove_headers=['Date'],
